  ...
  <div class="about">
    <div class="content-area">
      <div class="quest-area">
        ...
        <p class="quest">
          <b
            >What happens when a software engineer, driven by a relentless
            curiosity, begins to look beyond the code and turns their gaze
            towards the stars and the vast expanse of the cosmos?</b
          >
        </p>
      </div>
      <p class="cont">
        ...
        astrophysics, particularly the signals of pulsars and the dynamics of
        galaxies.<br />
